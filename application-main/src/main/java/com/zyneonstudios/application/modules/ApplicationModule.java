...
public class ApplicationModule {
    ...
    public void onLoad() {
        NexusApplication.getLogger().log("[MODULES] loading "+name+"("+id+"-v"+version+")...");
    }

    public void onEnable() {
        NexusApplication.getLogger().log("[MODULES] enabling "+name+"("+id+"-v"+version+")...");
    }

    public void onDisable() {
        NexusApplication.getLogger().log("[MODULES] disabling "+name+"("+id+"-v"+version+")...");
    }
}