...
public class ExternalLaunchProfile
{
    ...
    /**
     * The program classpath (you can create it using the {@link fr327.theshark34.openlauncherlib.external.ClasspathConstructor})
     *
     * @see fr327.theshark34.openlauncherlib.external.ClasspathConstructor
     */
     ...
     * @param classPath The classpath (you can create it using the {@link fr327.theshark34.openlauncherlib.external.ClasspathConstructor})
