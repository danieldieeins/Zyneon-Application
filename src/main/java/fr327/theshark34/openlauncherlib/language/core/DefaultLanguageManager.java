...
import fr327.theshark34.openlauncherlib.configuration.api.ConfigurationManager;
...
public class DefaultLanguageManager extends LanguageManager
{
     ...
     */
    private final fr327.theshark34.openlauncherlib.configuration.api.ConfigurationManager configurationManager;
    ...
    public void registerLanguage(LanguageInfo identify, LanguageInfo name, String path)
    {
        try
        {
            ...
            {
                langMap.put(name.get().toLowerCase(), new fr327.theshark34.openlauncherlib.language.core.SimpleLanguage(name, this, identify, configuration));
            }
            else
            {
