...
public abstract class GameTweak
{
     ...
     * - {@link fr327.theshark34.openlauncherlib.minecraft.GameType#V1_13_HIGHER_FORGE}
    ...
    public static final GameTweak FORGE = new GameTweak()
    {
        ...
        {
            if (infos.getGameVersion().getGameType().equals(fr327.theshark34.openlauncherlib.minecraft.GameType.V1_8_HIGHER))
