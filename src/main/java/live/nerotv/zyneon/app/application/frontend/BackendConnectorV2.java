        ...
        if(request.equals("button.accessmode")) {
            if(auth.isLoggedIn()) {
                if(us.contains(auth.getAuthInfos().getUuid())) {
                    frame.getBrowser().loadURL("https://a.nerotv.live/zyneon/application/html/access.html");
                }
            }
            ...
            frame.getBrowser().loadURL("https://a.nerotv.live/zyneon/application/html/index.html");
            ...
            if(auth.isLoggedIn()) {
                ...
                frame.getBrowser().executeJavaScript("javascript:OpenModal('notLoggedIn')","https://a.nerotv.live/zyneon/application/html/account.html",5);
            }
